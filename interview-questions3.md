...
74. [设计模式六大原则])(./interview-questions3.md#74-设计模式六大原则)
75. [Mach-O](./interview-questions3.md#75-mach-o)
76. [iOS多线程实现生产者消费者问题](./interview-questions3.md#76-ios多线程实现生产者消费者问题)
77. [响应式编程](./interview-questions3.md#77-响应式编程)
78. 
...
- 内部数据结构：环形缓冲区
  ...
  参考：[NSMutableArray原理揭露](http://blog.joyingx.me/2015/05/03/NSMutableArray%20原理揭露/)
...
参考：[iOS启动优化之Mach-O相关术语](https://juejin.im/post/5d7dbd036fb9a06b2e3d229d)
...
参考：[iOS设计模式之(二)生产者-消费者](https://juejin.im/post/5d27dce4e51d4510774a88f0)
...
2. 响应式编程
   ...
   相关库：ReactiveCocoa、RxSwift

参考：[深入浅出－iOS函数式编程的实现 && 响应式编程概念](https://www.jianshu.com/p/7017a220f34c)
